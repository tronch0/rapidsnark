...
snarkjs groth16 setup pos.r1cs ${TAU_FILE_WITH_DIR} pos_0000.zkey
echo 1 | snarkjs zkey contribute pos_0000.zkey pos_0001.zkey --name='cont' -v
snarkjs zkey export verificationkey pos_0001.zkey verification_key.json
popd || exit
